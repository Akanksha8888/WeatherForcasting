...
def main(page: ft.Page):
    ...
    homepage_data = ft.Column([
        ...
        ft.Text(value=weather_data['Location'], font_family="Comfortaa-Bold", style='titleLarge',
                color=ft.colors.WHITE),
        ft.Container(height=25),
        ft.Image(src=f"weather_icons/{weather_data['IconLocation']}", width=150),
        ft.Container(height=10),
        ft.Text(value=f"{weather_data['Climate']}", font_family="Comfortaa-Light", style='titleLarge',
                color=ft.colors.WHITE),
        ft.Text(value=f"{int(round(float(weather_data['Temperature (°C)'])))}°", font_family='Comfortaa-Light',
                style='displayLarge', color=ft.colors.WHITE, size=100),
        ft.Container(height=25),
    ...
    splash_screen_data = ft.Column([
        ...
        ft.Container(height=20),
        ft.Container(
            content=ft.Text('Check Weather', font_family='Comfortaa-Medium',
                            style='labelLarge'),
            bgcolor='#019877',
            border_radius=20,
            padding=10
    ...
    weather_indepth_data = ft.Column([
        ...
        ft.Row([
            ...
            ft.Text(value=weather_data['Humidity'], font_family="Comfortaa-Light", style='titleLarge',
                    color=ft.colors.WHITE),
        ], alignment=ft.MainAxisAlignment.SPACE_BETWEEN),
        ft.Container(height=5),
        ft.Row([
            ft.Text(value='Wind Speed', font_family="Comfortaa-Light", style='titleLarge', color=ft.colors.WHITE),
            ft.Text(value=weather_data['WindSpeed'], font_family="Comfortaa-Light", style='titleLarge',
                    color=ft.colors.WHITE),
        ], alignment=ft.MainAxisAlignment.SPACE_BETWEEN),
        ft.Container(height=5),
        ft.Row([
            ft.Text(value='Pressure', font_family="Comfortaa-Light", style='titleLarge', color=ft.colors.WHITE),
            ft.Text(value=weather_data['Pressure'], font_family="Comfortaa-Light", style='titleLarge',
                    color=ft.colors.WHITE),
        ], alignment=ft.MainAxisAlignment.SPACE_BETWEEN),
        ft.Container(height=5),
        ft.Row([
            ft.Text(value='Precipitation', font_family="Comfortaa-Light", style='titleLarge', color=ft.colors.WHITE),
            ft.Text(value=weather_data['Precipitation'], font_family="Comfortaa-Light", style='titleLarge',
                    color=ft.colors.WHITE),
        ], alignment=ft.MainAxisAlignment.SPACE_BETWEEN),
        ft.Container(height=5),
        ft.Row([
            ft.Text(value='Gust', font_family="Comfortaa-Light", style='titleLarge', color=ft.colors.WHITE),
            ft.Text(value=weather_data['Gust'], font_family="Comfortaa-Light", style='titleLarge',
                    color=ft.colors.WHITE),
        ], alignment=ft.MainAxisAlignment.SPACE_BETWEEN),
        ft.Container(height=5),
        ft.Row([
            ft.Text(value='UV Index', font_family="Comfortaa-Light", style='titleLarge', color=ft.colors.WHITE),
            ft.Text(value=weather_data['UVIndex'], font_family="Comfortaa-Light", style='titleLarge',
                    color=ft.colors.WHITE),
        ], alignment=ft.MainAxisAlignment.SPACE_BETWEEN),
        ft.Container(height=5),
        ft.Divider(color=ft.colors.WHITE),
